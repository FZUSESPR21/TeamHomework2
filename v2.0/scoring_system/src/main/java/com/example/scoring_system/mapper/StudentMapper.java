...
public interface StudentMapper {
    ...
    @Insert("INSERT INTO user(id,account,user_name,password,perms,salt,total_score,team_id,team_change_history,class_id classId,token_salt,pair_team_id) VALUES(DEFAULT,#{account},#{userName},#{password},null,#{salt},0,#{teamId},null,#{classId},null,null)")
    Integer addSingleStudent(User user);

    @Delete("delete from user where id = #{id} and account like 'S%'")
    Integer delStudent(String id);
    ...
    List<User> selByPage(int pageNo, int pageSize);
    ...
    User selStuByAccount(String account);
